...
/**
 * author:lgh on 2019-12-19 11:38
 */
public class SignaturePad extends View {
    ...
    private boolean ismEraser;
    private Paint mEraserPaint;
    private boolean ismBackStep;
    ...
    public void setIsmEraser(boolean ismEraser) {
        this.ismEraser = ismEraser;
        if (ismEraser) {
    ...
    private void addBezier(Bezier curve, float startWidth, float endWidth) {
        ...
        for (int i = 0; i < drawSteps; i++) {
            ...
            if (ismEraser)
                mSignatureBitmapCanvas.drawPoint(x, y, mEraserPaint);
            else
    ...
    public void setBrushPreset(BrushPreset brushPreset) {
        clear();
        setMinWidth(brushPreset.size);
        setMaxWidth(brushPreset.size + 3);
        mPaint.setColor(brushPreset.color);
        if (brushPreset.blurStyle != null && brushPreset.blurRadius > 0) {
            mPaint.setMaskFilter(new BlurMaskFilter(brushPreset.blurRadius,
                    brushPreset.blurStyle));
        } else {
