...
public class ColorPickerPopup {
    ...
    public void show(View parent, final ColorPickerObserver observer) {
        ...
        View layout = inflater.inflate(R.layout.kcb_picker_color_popup, null);
        final ColorPickerView colorPickerView = (ColorPickerView) layout.findViewById(R.id.colorPickerView);
        ...
        final TextView colorHex = (TextView) layout.findViewById(R.id.colorHex);
