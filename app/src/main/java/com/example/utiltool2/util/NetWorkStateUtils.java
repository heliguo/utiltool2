...
public class NetWorkStateUtils {
    ...
    public static String getType(NetWorkType type) {
        if (type != null) {
            switch (type) {
                case Wifi:
                    return "wifi";
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            Log.i("network","getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
                    Log.i("network","NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    Log.i("network","NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    Log.i("network","NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    Log.i("network","NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
                Log.i("network","\n");
            } else {
                Log.i("network","getAllNetworkInfo is null");
            }
        }
        return false;
    }
